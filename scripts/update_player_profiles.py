...
from ranking_snapshot import FEATURED_RANKINGS, RANKING_SNAPSHOT
...
def build_tour(archive: Path, tour: str) -> list[dict[str, object]]:
    ...
    profiles = []
    for display, source_name, rank, points in FEATURED_RANKINGS[tour]:
...
def main() -> None:
    ...
    args.output.write_text(
        ...
        f"// Rankings: ATP/WTA snapshot {RANKING_SNAPSHOT.isoformat()}. "
        f"History: Sackmann archive through {DATA_CUTOFF.isoformat()}.\n"
